...
const GlowingEffect = memo(
    ({
        ...
        movementDuration = 2,
        borderWidth = 1,
        disabled = false, // Changed from true to false by default for easier use
    }: GlowingEffectProps) => {
